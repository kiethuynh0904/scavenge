...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/kiethuynh0904/scavenge/scavenge/commit
   */
  queryCommitAll = (
    query?: {
    ...
    this.request<ScavengeQueryAllCommitResponse, RpcStatus>({
      path: `/kiethuynh0904/scavenge/scavenge/commit`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/kiethuynh0904/scavenge/scavenge/commit/{index}
   */
  queryCommit = (index: string, params: RequestParams = {}) =>
    this.request<ScavengeQueryGetCommitResponse, RpcStatus>({
      path: `/kiethuynh0904/scavenge/scavenge/commit/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/kiethuynh0904/scavenge/scavenge/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ScavengeQueryParamsResponse, RpcStatus>({
      path: `/kiethuynh0904/scavenge/scavenge/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/kiethuynh0904/scavenge/scavenge/scavenge
   */
  queryScavengeAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<ScavengeQueryAllScavengeResponse, RpcStatus>({
      path: `/kiethuynh0904/scavenge/scavenge/scavenge`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/kiethuynh0904/scavenge/scavenge/scavenge/{index}
   */
  queryScavenge = (index: string, params: RequestParams = {}) =>
    this.request<ScavengeQueryGetScavengeResponse, RpcStatus>({
      path: `/kiethuynh0904/scavenge/scavenge/scavenge/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
